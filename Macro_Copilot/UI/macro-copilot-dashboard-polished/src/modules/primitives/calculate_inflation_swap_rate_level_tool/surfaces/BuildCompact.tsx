...
// primitive ships a compact view; this is ZCIS rate_level's.  Mounted as a
...
const BuildCompact: React.FC<BuildCompactProps> = ({
  ...
  // Identity mirrors the mockup: "EUR ZCIS · 5Y · HICPxT" with flag.
  // Primary line is "<market> ZCIS"; secondary line is the tenor.
  const primary = meta ? `${meta.marketShort} ZCIS` : curveFamily;

  return (
    <BuildCompactShell
      toolDisplayName="ZCIS Rate Level"
      statusPill="SNAPSHOT"
