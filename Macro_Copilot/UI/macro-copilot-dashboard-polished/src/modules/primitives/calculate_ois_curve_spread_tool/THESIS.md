...
**Backend artifact:** `calculate_ois_curve_spread_tool` (generic_runnable)
...
Basis-point spread between two tenors on the same OIS curve (e.g. SOFR 2s10s) with rolling 252-day z-score, daily change, and both canonical and bespoke wire-frozen time series.
