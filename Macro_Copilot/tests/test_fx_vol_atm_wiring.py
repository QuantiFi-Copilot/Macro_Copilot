"""Wiring tests for Phase E1 ATM vol tools.
...
Mirror of tests/test_fx_ndf_wiring.py.
"""
...
def main() -> int:
    ...
    check("MCP: 4 vol tools registered on fx-agent server", check_mcp_registration)
