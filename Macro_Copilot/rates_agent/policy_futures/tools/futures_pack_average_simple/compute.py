...
on the intersection of trading days, and emits a snapshot of:
  ...
  - the methodology disclosure (P5 / ADR 0011 — simple arithmetic-
...
ADR 0011 V1 HARD scope — EUR_SHORT_RATE_FUT refusal
---------------------------------------------------
...
missing playbook metadata AND citing ADR 0011 as the source of the
...
# before a pack-average can be computed honestly. ADR 0011 V1 names
...
def _build_methodology_disclosure(
    *,
    ...
    """Compose the P5 / ADR 0011 disclosure string with runtime
    ...
    return (
        ...
        f"primitives (ADR 0011 V1 scope — policy_futures ships "
...
def calculate_futures_pack_average_simple(
    ...
    # ------------------------------------------------------------------
    # ADR 0011 V1 hard gate — refuse EUR_SHORT_RATE_FUT and any other
    ...
    if params.curve_family in _BUBA_MIX_CURVE_FAMILIES:
        raise NotImplementedError(
            ...
            f"honest behaviour (see ADR 0011 — "
