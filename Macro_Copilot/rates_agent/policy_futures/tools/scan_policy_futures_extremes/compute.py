...
open_interest_level). V1 monitor under ``policy_futures`` (ADR 0011 —
...
def _build_methodology_disclosure(
    *,
    ...
    """Compose the P5 / ADR 0011 disclosure string with the runtime
    ...
    return (
        ...
        f"ADR 0011). This is a morning screen, NOT a tactical "
        f"trade signal."
    )
