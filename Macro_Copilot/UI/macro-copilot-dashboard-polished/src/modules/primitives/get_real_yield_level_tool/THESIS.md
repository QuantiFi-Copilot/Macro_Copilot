...
**Backend artifact:** `get_real_yield_level_tool` (generic_runnable)
...
Single-tenor sovereign-linker real-yield snapshot — current yield, daily / weekly / monthly change in bps, rolling 252-day z-score, trailing 252-day high / low / percentile, and full chartable time series. Linker analogue of get_yield_levels.
