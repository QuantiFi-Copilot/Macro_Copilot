...
**Backend artifact:** `calculate_cross_country_real_yield_spread_simple_tool` (generic_runnable)
...
Cross-country sovereign-linker real-yield spread (e.g. US TIPS vs UK linker 10Y) — country-A real yield minus country-B real yield at a matched tenor, with rolling 252-day z-score. The "simple" name denotes the unadjusted cross-country pairing (no FX adjustment).
