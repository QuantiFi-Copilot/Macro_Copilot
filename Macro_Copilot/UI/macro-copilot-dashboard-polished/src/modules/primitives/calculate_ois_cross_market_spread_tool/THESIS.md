...
**Backend artifact:** `calculate_ois_cross_market_spread_tool` (generic_runnable)
...
Cross-market OIS rate differential between the same tenor on two OIS curves (e.g. SOFR 2Y − ESTR 2Y), with rolling 252-day z-score, daily / weekly / monthly change, trailing range, and both canonical and bespoke time series.
