// ============================================================================
// src/modules/primitives/calculate_beta_adjusted_spread_tool/surfaces/PreviewWidget.tsx
// ----------------------------------------------------------------------------
...
function PreviewWidget(props: NodeRenderProps) {
  return <RichModelWidget {...props} toolName="calculate_beta_adjusted_spread_tool" />;
}
