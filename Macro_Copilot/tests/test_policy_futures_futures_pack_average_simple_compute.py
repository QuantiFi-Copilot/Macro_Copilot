...
Covers:
 ...
 11. EUR_SHORT_RATE_FUT refusal: ADR 0013 V1 gate raises
     NotImplementedError with delivery_month_type + ADR 0013 in the
     message.
...
# ===========================================================================
# 9. EUR_SHORT_RATE_FUT refusal (ADR 0013 V1)
# ===========================================================================
...
class TestEurShortRateFutRefusedPr11:
    ...
    citing both the missing metadata and ADR 0013 — the canonical
    ...
    def test_eur_short_rate_fut_refused_pr11(self):
        ...
        # AND it MUST cite ADR 0013 so the disclosure surface is
        # auditable.
        assert "ADR 0013" in msg
