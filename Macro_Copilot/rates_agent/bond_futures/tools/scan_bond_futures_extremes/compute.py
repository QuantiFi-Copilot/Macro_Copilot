...
spread stack per ADR 0011's V1 scope.
...
tenor-anchored yield call"). The disclosure includes:
  ...
  - the rolling-generic-price / non-DV01-spread / non-tenor-anchored-
    yield-call caveats per ADR 0011 V1 scope.
...
# P5 / ADR 0011 / catalog-guardrail disclosure template. Emitted on
...
_METHODOLOGY_DISCLOSURE_TEMPLATE: str = (
    ...
    "D-deliverable data ingestion (ADR 0011 — bond_futures V1 ships "
    "monitors only)."
)
