...
**Backend artifact:** `calculate_forward_breakeven_simple_tool` (generic_runnable)
...
Forward bond-implied breakeven (e.g. 5Y5Y breakeven) computed from two spot bond-implied breakeven legs. The "simple" name denotes the textbook log-additive forward construction without carry / seasonals adjustments.
