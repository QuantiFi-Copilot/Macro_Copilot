...
under the new ``bond_futures`` domain (ADR 0011) — V1 monitors-only.
...
P5 / ADR 0011 caveat verbatim — "this is the rolling-generic price;
...
# P5 / ADR 0011 disclosure — emitted on every response so the consumer
...
METHODOLOGY_DISCLOSURE: str = (
    ...
    "yet a primitive in this build (ADR 0011 — bond_futures V1 ships "
...
def calculate_futures_price_level(
    ...
    # and belong to the policy_futures domain agent per ADR 0011.
