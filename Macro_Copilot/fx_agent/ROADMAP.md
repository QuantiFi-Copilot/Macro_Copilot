...
**Branch:** `codex/fx-data-universe-bbg-warehouse-seed` — stacked on `codex/fx-data-universe-bbg-topup` (PR #203 visibility-only), itself stacked on `codex/fx-data-universe-bbg-batch` (PR #198), `codex/fx-data-universe-phase-b-followup` (PR #191), `codex/fx-data-universe-phase-b` (PR #189), `codex/fx-data-universe-extension` (PR #184), `codex/fx-on-latest-build` (PR #178).

**Phase in flight:** **All substrate seeding work ✅ COMPLETE through warehouse-seed.** Tier 1 progress: A ✅, B-core ✅, B-followup ✅, BBG batch ✅, BBG top-up ✅, BBG warehouse-seed ✅ (Tier 3 Phase F macro-index substrate is also now seeded as a side-effect of warehouse seeding). 638 FX instruments in DB across 6 instrument_types:
