...
def _well_formed_output() -> dict:
    ...
    return {
        ...
        "time_series_volume": {
            "series_name": "sofr_fut_1_volume",
            "units": "contracts",
            "description": (
                "Daily traded volume for SOFR_FUT strip position 1 "
                "in CONTRACTS."
            ),
            "rows": [
        ...
        "time_series_open_interest": {
            "series_name": "sofr_fut_1_open_interest",
            "units": "contracts",
            "description": (
                "End-of-day open interest for SOFR_FUT strip "
                "position 1 in CONTRACTS."
            ),
            "rows": [
                {"date": "2026-04-29", "value": 1033333.0},
                {"date": "2026-04-30", "value": 1045678.0},
            ],
        },
...
class TestWorkflowRegistration:
    ...
    def test_classified_bridgeable_series(self):
        ...
        BRIDGEABLE_SERIES post-ADR-0017 (despite the tool's name the
        output carries dated volume/OI history rows)."""
