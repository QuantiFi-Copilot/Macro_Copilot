...
**Backend artifact:** `policy_futures_get_futures_cross_market_spread_tool` (generic_runnable)
...
Matched-strip cross-market implied-rate differential on the policy-.
