// ============================================================================
// src/modules/primitives/calculate_yield_change_attribution_pca_tool/surfaces/PreviewWidget.tsx
// ----------------------------------------------------------------------------
...
function PreviewWidget(props: NodeRenderProps) {
  return <RichModelWidget {...props} toolName="calculate_yield_change_attribution_pca_tool" />;
}
