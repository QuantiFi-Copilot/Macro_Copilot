...
// ============================================================================
// src/modules/primitives/calculate_otr_ofr_spread_tool/__tests__/module.spec.ts
// ----------------------------------------------------------------------------
...
const FOLDER = 'calculate_otr_ofr_spread_tool';
...
check('monitorWidgets declares the otr_ofr_spread tile', () => {
  const widgets = MODULE.monitorWidgets ?? [];
  const id = 'otr_ofr_spread';
