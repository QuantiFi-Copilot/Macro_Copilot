...
// ============================================================================
// src/modules/primitives/calculate_inflation_swap_curve_spread_tool/__tests__/module.spec.ts
// ----------------------------------------------------------------------------
...
// one check.  Extends the standard boilerplate with the dual-view
...
// AND surfaces.buildCompact.  Identical shape to the breakeven_curve_spread
...
const FOLDER = 'calculate_inflation_swap_curve_spread_tool';
