...
**Backend artifact:** `get_ois_rate_level_tool` (generic_runnable)
...
Single-tenor OIS par-swap-rate snapshot — current rate, daily / weekly / monthly change, rolling 252-day z-score, trailing 252-day high / low / percentile, plus full chartable time series.  OIS analogue of get_yield_levels.
