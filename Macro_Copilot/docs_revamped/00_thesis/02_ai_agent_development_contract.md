...
| Add a new primitive | Load-bearing | **`02_components/primitive/BUILD_GUIDE.md`** (the single front-door manual — covers all 8 lifecycle stages end-to-end + every cross-reference in order). Cross-references it consumes internally: `02_components/primitive/README.md` (PR1–PR16 doctrine), `02_components/primitive/runbook.md` (backend procedure subset), `03_standards/methodology_exposure.md` (exposure: blocks + standalone bridge), `03_standards/rendering_density.md` (dual Build-view mandate), `03_standards/tool_lifecycle.md` (7 axes), `03_standards/lifecycle_checklist_template.md` (8-stage per-tool tracker; copy §10 into the tool folder), `03_standards/test_patterns.md`, `02_components/frontend_module/README.md` (FM1–FM12), `02_components/frontend_module/thesis_template.md`, `05_decisions/0015-tool-metadata-db-table.md` (DB curated migration). |
