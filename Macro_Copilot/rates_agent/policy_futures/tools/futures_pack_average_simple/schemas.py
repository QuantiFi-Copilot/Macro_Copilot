...
# Note: EUR_SHORT_RATE_FUT is REFUSED at compute time (per ADR 0013 V1
...
class FuturesPackAverageSimpleInput(BaseModel):
    ...
    Keyed by ``(curve_family, pack)`` per ADR 0013 V1 scope. The
    ...
    curve_family: PolicyFuturesPackAverageCurveFamily = Field(
        ...
        description=(
            ...
            "IBOR regime — REFUSED at compute time per ADR 0013 V1 "
