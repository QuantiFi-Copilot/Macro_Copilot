...
# is UNCHANGED at 1,000: card discipline is enforced per operator
# (every card is under it); the total is only the fleet-size budget.
_PER_CARD_TOKEN_CAP = 1_000
_TOTAL_CATALOGUE_TOKEN_CAP = 46_000
