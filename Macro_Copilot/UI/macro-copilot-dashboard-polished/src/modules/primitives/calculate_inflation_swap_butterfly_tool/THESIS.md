...
**Backend artifact:** `calculate_inflation_swap_butterfly_tool` (generic_runnable)
...
Three-point ZCIS butterfly with fixed 50-50 weights (e.g. USD ZCIS 2s5s10s butterfly) and rolling 252-day z-score. ZCIS analogue of calculate_butterfly.
