...
**Backend artifact:** `build_sovereign_yield_panel_tool` (generic_runnable)
...
Wide multi-instrument Panel of sovereign yields keyed by `<curve_family>_<tenor>` over a date range. Designed as the backtest workflow\
