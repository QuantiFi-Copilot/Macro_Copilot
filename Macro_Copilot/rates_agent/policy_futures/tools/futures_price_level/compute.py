...
primitive under the new ``policy_futures`` domain (ADR 0011) — V1
...
P5 / ADR 0011 caveat verbatim — "rolling-generic strip read at
...
def _build_methodology_disclosure(
    *,
    ...
    return (
        ...
        f"primitive in this build (ADR 0011 V1 scope — policy_futures "
