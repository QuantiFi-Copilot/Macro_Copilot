...
**Backend artifact:** `calculate_breakeven_butterfly_tool` (generic_runnable)
...
Three-point bond-implied breakeven butterfly with fixed 50-50 weights (e.g. US 2s5s10s breakeven butterfly) and rolling 252-day z-score. Breakeven analogue of calculate_butterfly.
