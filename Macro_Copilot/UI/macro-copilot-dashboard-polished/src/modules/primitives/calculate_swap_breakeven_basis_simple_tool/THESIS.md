...
**Backend artifact:** `calculate_swap_breakeven_basis_simple_tool` (generic_runnable)
...
Swap-vs-bond inflation basis (e.g. USD ZCIS 10Y minus US TIPS bond-implied breakeven 10Y) — the cleanest read of the swap-bond inflation pricing gap. The "simple" name denotes the unadjusted pairing (no carry / seasonals adjustment).
