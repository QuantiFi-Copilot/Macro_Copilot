// ============================================================================
// src/modules/primitives/calculate_rolling_regression_tool/surfaces/PreviewWidget.tsx
// ----------------------------------------------------------------------------
...
function PreviewWidget(props: NodeRenderProps) {
  return <RichModelWidget {...props} toolName="calculate_rolling_regression_tool" />;
}
