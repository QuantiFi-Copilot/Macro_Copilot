...
**Backend artifact:** `compute_financing_rate_tool` (generic_runnable)
...
Daily financing-rate Panel keyed by `<curve_family>` for use as the financing input to the backtest workflow\
