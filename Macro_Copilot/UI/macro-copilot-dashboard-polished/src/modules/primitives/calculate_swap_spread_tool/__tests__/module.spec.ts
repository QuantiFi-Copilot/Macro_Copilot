...
// ============================================================================
// src/modules/primitives/calculate_swap_spread_tool/__tests__/module.spec.ts
// ----------------------------------------------------------------------------
// Per-module round-trip — calls assertStandardModuleInvariants from
// src/modules/__test-utils.ts (FM11 invariants 1-8 in one check), plus the
// Phase-1 dual-view + standalone-bridge contract checks
// (rendering_density.md §11 + methodology_exposure.md §5).
// ============================================================================

import { assertStandardModuleInvariants } from '../../../__test-utils';
import { MODULE } from '../module';

const FOLDER = 'calculate_swap_spread_tool';
