...
V1 monitor #3 for the ``bond_futures`` domain (ADR 0011) — universe-
...
commodity DV01-weighted spread stack per ADR 0011 (V1 monitors-only).
...
class ScanBondFuturesExtremesInput(BaseModel):
    ...
    curve_families: Optional[List[str]] = Field(
        ...
        description=(
            ...
            "futures curve family per ADR 0011 — passing a policy-"
    ...
    def _validate_curve_families_whitelist(self) -> "ScanBondFuturesExtremesInput":
        ...
        if invalid:
            ...
            raise ValueError(
                ...
                f"futures closed-family whitelist (per ADR 0011 V1 "
...
class ScanBondFuturesExtremesResultRow(BaseModel):
    ...
    methodology_disclosure: str = Field(
        ...
        min_length=1,
        description=(
            "P5 / ADR 0011 / catalog-guardrail disclosure — REQUIRED "
...
class ScanBondFuturesExtremesOutput(BaseModel):
    ...
    methodology_disclosure: str = Field(
        ...
        min_length=1,
        description=(
            "P5 / ADR 0011 / catalog-guardrail disclosure carried on "
