...
BUCKET_NAME = "macro-parquet-drop-xyz" 

def push_playbooks_to_gcp():
    """Syncs local YAML playbooks to the GCP bucket."""
    
    # --- DYNAMIC PATH RESOLUTION ---
    # Script is located at: /Volumes/Sreeram/Macro/Macro_Copilot/utils/push_playbooks.py
    ...
    # FIXED PATH: Included the 'agents' directory
    playbooks_dir = project_root / "agents" / "rates_agent" / "playbooks"
    ...
    # 2. Verify the playbooks directory exists
