...
**Backend artifact:** `calculate_inflation_swap_forward_tool` (generic_runnable)
...
Forward inflation swap rate (e.g. 5Y5Y inflation) computed from two spot ZCIS legs via closed-form forward construction. ZCIS analogue of calculate_ois_forward_rate.
