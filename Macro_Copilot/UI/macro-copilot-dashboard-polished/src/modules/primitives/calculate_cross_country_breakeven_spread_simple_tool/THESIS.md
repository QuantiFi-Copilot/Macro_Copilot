...
**Backend artifact:** `calculate_cross_country_breakeven_spread_simple_tool` (generic_runnable)
...
Cross-country bond-implied breakeven spread (e.g. US TIPS vs Gilt linker 10Y) — country-A breakeven minus country-B breakeven at a matched tenor, with rolling 252-day z-score and a full chartable time series. The "simple" name denotes the unadjusted cross-country pairing (no FX adjustment).
