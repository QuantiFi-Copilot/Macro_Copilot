...
### 2.1 Operators (46 — 16 at PoC + Track-A fable_build additions (covariance, rolling_covariance, regression_residual, beta, lead_lag, granger_causality, cross_sectional_rank, cross_sectional_zscore, cross_sectional_statistic, demean_cross_section, top_n, pairwise_spread_matrix, weighted_combination, ewm_statistic, lag, cumulative, winsorize, resample, detrend, hp_filter, bandpass, streak, transition_events, stationarity_adf, ljung_box, normality_test, variance_ratio, hurst_exponent, fit_ou, changepoint_detection); finance-blind, in `OPERATOR_REGISTRY` at [shared/workflow/registry.py:324](../shared/workflow/registry.py:324))
