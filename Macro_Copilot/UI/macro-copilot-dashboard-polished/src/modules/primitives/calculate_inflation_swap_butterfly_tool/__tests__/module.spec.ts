...
// ============================================================================
// src/modules/primitives/calculate_inflation_swap_butterfly_tool/__tests__/module.spec.ts
// ----------------------------------------------------------------------------
// Round-1 per-module round-trip — calls assertStandardModuleInvariants
// from src/modules/__test-utils.ts.  Catches FM11 invariants 1-8 in
// one check.  Extends the standard boilerplate with the Phase-1 dual-view
// rendering-density contract checks (rendering_density.md §11): every new
// primitive claiming custom_build_surface MUST ship BOTH surfaces.buildExtended
// AND surfaces.buildCompact.  Identical shape to the real_yield_butterfly /
// cross_market_inflation_swap_spread sibling module tests.
// ============================================================================

import { assertStandardModuleInvariants } from '../../../__test-utils';
import { MODULE } from '../module';

const FOLDER = 'calculate_inflation_swap_butterfly_tool';
