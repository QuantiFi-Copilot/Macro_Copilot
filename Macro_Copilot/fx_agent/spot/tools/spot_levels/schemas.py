"""
Pydantic input/output schemas for the FX spot level tool.
"""
...
class FXSpotLevelMetrics(BaseModel):
    ...
    daily_change_pct: Optional[float] = Field(None, description="1-day percentage change.")
    weekly_change_pct: Optional[float] = Field(None, description="5-trading-day percentage change.")
    monthly_change_pct: Optional[float] = Field(None, description="21-trading-day percentage change.")
    ...
    high_252d: Optional[float] = Field(
        None,
        description="Highest spot level over trailing 252 trading days.",
    )
    low_252d: Optional[float] = Field(
        None,
        description="Lowest spot level over trailing 252 trading days.",
    )
