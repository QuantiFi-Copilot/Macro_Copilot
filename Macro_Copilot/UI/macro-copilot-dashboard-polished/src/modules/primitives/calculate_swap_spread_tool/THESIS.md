...
**Backend artifact:** `calculate_swap_spread_tool` (generic_runnable)
...
Cross-domain spread between a sovereign yield and an OIS rate at the same tenor (e.g. UST 10Y − SOFR 10Y) under the convention (sovereign − ois) × 100 bps, with snapshot, daily / weekly / monthly change, rolling z-score, trailing range, and time series.
